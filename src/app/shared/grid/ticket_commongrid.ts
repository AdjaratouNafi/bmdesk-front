...
@Component({
    moduleId: module.id,
    selector: 'ticket-commongrid',
    templateUrl: './ticket_commongrid.html',
    host: {
        '(document:click)': 'onDocumentClick($event)',
    },
})

export class ticket_commongrid_Component {
    @Input() ModuleType: string = "ticket"; //ticket|solution|problem|change
    @Input() records: any;
    allItems: Array<any>[];
    ...
    dtConfig: FlatpickrOptions = this.service.CommonDateConfig();
    ...
    RowDbClick(item: any) {
        if (this.Edit && this.service.Account.Is_EditRow_On_DoubleClick) {
